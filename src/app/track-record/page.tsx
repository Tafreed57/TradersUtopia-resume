...
export default function TrackRecordPage() {
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-900 via-gray-800/90 to-gray-900/95 text-white'>
      {/* Shared Navigation */}
        ...
        <div className='relative pt-8 pb-12 px-4 sm:px-6 lg:px-8 pwa-safe-top'>
          ...
          <div className='relative max-w-6xl mx-auto text-center'>
            ...
            <p className='text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed'>
              Complete transparency in our trading performance. Every trade, win
              or loss, documented in real-time for your review. Our professional
              traders share their insights and results here.
            </p>
