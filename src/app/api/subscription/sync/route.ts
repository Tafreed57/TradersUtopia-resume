...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(
      `🔍 [SYNC] Period start: ${activeSubscription.current_period_start} (type: ${typeof activeSubscription.current_period_start})`,
    );
    console.log(
      `🔍 [SYNC] Period end: ${activeSubscription.current_period_end} (type: ${typeof activeSubscription.current_period_end})`,
    );
    console.log(
    ...
    console.log(
      `🔍 [SYNC] Subscription level periods: start=${activeSubscription.current_period_start}, end=${activeSubscription.current_period_end}`,
    );
    console.log(
      `🔍 [SYNC] Item level periods: start=${subscriptionItem.current_period_start}, end=${subscriptionItem.current_period_end}`,
    );
    console.log(
