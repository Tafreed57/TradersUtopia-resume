            ...
            <div className='lg:col-span-3 space-y-12'>
              ...
              <section className='bg-gradient-to-br from-blue-900/20 via-gray-800/40 to-gray-900/40 rounded-2xl p-6 sm:p-8 border border-blue-400/30 backdrop-blur-sm'>
                ...
                <p className='text-gray-300 text-lg leading-relaxed'>
                  This Privacy Policy describes how Traders Utopia ("we", "us",
                  or "our") collects, uses, and discloses your information when
                  you visit our website (the "Site") or use our services (the
                  "Services").
                </p>
              </section>
              ...
              >
                ...
                <div className='bg-yellow-900/20 rounded-xl p-4 border border-yellow-400/30'>
                  <p className='text-gray-300 text-sm'>
                    ...
                    technologies to understand how you interact with the
                    Services.
                  </p>
                </div>
              </section>
                  ...
                  <div className='space-y-3'>
                    ...
                    <div className='flex items-start gap-3 p-3 bg-purple-900/20 rounded-lg border border-purple-400/30'>
                      ...
                      <div>
                        ...
                        <p className='text-gray-300 text-sm'>
                          Send marketing and promotional communications (with
                          your consent)
                        </p>
                      </div>
                    </div>
              ...
              >
                ...
                <div className='space-y-4'>
                  <div className='bg-orange-900/20 rounded-xl p-4 border border-orange-400/30'>
                    ...
                    <p className='text-gray-300 text-sm'>
                      Such as payment processors, data analysts, and other
                      service providers necessary for business operations.
                    </p>
                  </div>
