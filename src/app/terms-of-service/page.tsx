...
export default function TermsOfServicePage() {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white pwa-layout safe-min-height'>
            ...
            <div className='lg:col-span-3 space-y-12'>
              ...
              >
                ...
                <p className='text-gray-300 leading-relaxed'>
                  ...
                  services. All information you provide must be accurate and up
                  to date. You agree to use the Platform only for lawful
                  purposes.
                </p>
              </section>
              ...
              >
                ...
                <p className='text-gray-300 leading-relaxed'>
                  Trader's Utopia offers educational content and tools only. We
                  do not provide financial, investment, or trading advice of any
                ...
                <div className='space-y-6'>
                  ...
                  <div className='bg-yellow-900/20 rounded-xl p-6 border border-yellow-400/30'>
                    ...
                    <p className='text-gray-300'>
                      By subscribing to Trader's Utopia, you agree not to
                      initiate chargebacks or payment disputes with your
                      financial institution. All sales are final. Any
                      unauthorized chargebacks will be treated as potential
                      fraud, and we reserve the right to pursue legal action and
                      ban the associated user accounts permanently.
                    </p>
                  </div>
                </div>
              </section>
              ...
              >
                ...
                <p className='text-gray-300 leading-relaxed'>
                  Trader's Utopia makes no representations or guarantees
                  regarding earnings, profits, or income. Any examples of
                  trading success shown on our Platform or social media are
                  exceptional results and not typical. Your success depends on
                  your own decisions, skills, market conditions, and risk
                  tolerance. You may lose money. By using our services, you
                  accept full responsibility for your trading and financial
                  outcomes.
                </p>
              </section>
              ...
              >
                ...
                <p className='text-gray-300 leading-relaxed mb-6'>
                  ...
                  suitable for all investors. Past performance does not
                  guarantee future results. You must carefully consider your
                ...
                <div className='space-y-4'>
                  <div className='bg-red-900/20 rounded-xl p-4 border border-red-400/30'>
                    ...
                    <p className='text-gray-300'>
                      Futures and options trading involve substantial risk of
                      loss and are not suitable for all investors.
                    </p>
                  </div>
              ...
              >
                ...
                <div className='space-y-4'>
                  <div className='bg-purple-900/20 rounded-xl p-4 border border-purple-400/30'>
                    ...
                    <p className='text-gray-300'>
                      Affiliates acknowledge that any participation is a
                      revocable privilege, not a right. Trader's Utopia may
                      modify, suspend, or terminate any affiliate's access,
                      commission rate, or participation at any time and for any
                  ...
                  <div className='bg-purple-900/20 rounded-xl p-4 border border-purple-400/30'>
                    ...
                    <p className='text-gray-300'>
                      ...
                      rights to pursue damages, loss of future income, or
                      business interruption claims if your affiliate access is
                      terminated. Any attempt to damage the business,
                      reputation, or operations of Trader's Utopia will be
                      treated as malicious interference and may result in civil
                      legal action.
                    </p>
                  </div>
                </div>
