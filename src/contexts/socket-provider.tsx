...
export const SocketProvider = ({ children }: {children : React.ReactNode}) => {
    ...
    useEffect(() => {
        ...
        client.io.engine.on('upgrade', () => {
            console.log('🔄 [Socket] Transport upgraded to:', client.io.engine.transport.name);
        });
        ...
        const timeoutId = setTimeout(() => {
            if (!client.connected) {
                console.warn('⏰ [Socket] Connection timeout, app will continue without real-time features');
                setConnectionError('Connection timeout - app will work without real-time features');
            }
        }, 8000); // Longer timeout
