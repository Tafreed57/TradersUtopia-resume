          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-3 text-sm text-gray-300 mb-4">
                <span className="font-mono bg-gray-700/50 px-3 py-1 rounded-lg">@{user.username || user.firstName?.toLowerCase()}</span>
      ...
      <Card className="bg-gradient-to-br from-gray-700/50 via-gray-800/40 to-gray-900/50 border border-gray-600/30 backdrop-blur-md hover:border-purple-400/50 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-400/10">
        <CardContent className="p-8">
          ...
          <div className="space-y-6">
            ...
            <div className={`group p-6 bg-gradient-to-br from-gray-800/40 to-gray-900/40 rounded-2xl border border-gray-600/30 hover:border-${passwordInfo.isOAuth ? 'blue' : hasPassword ? 'green' : 'red'}-400/50 transition-all duration-300 hover:shadow-lg hover:shadow-${passwordInfo.isOAuth ? 'blue' : hasPassword ? 'green' : 'red'}-400/10`}>
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
        ...
        <CardContent className="p-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-800/40 to-gray-900/40 rounded-xl border border-gray-600/30 hover:border-gray-500/50 transition-all duration-300">
              ...
              <Badge variant={hasPassword ? "default" : "outline"} className={hasPassword ? "bg-gradient-to-r from-green-600 to-green-700 border-green-500" : ""}>
            ...
            {oauthAccounts.map((account) => (
              <div key={account.id} className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-800/40 to-gray-900/40 rounded-xl border border-gray-600/30 hover:border-blue-400/50 transition-all duration-300">
                <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-800/40 to-gray-900/40 rounded-xl border border-gray-600/30 hover:border-green-400/50 transition-all duration-300">
              ...
              {isLoadingProfile ? (
                ...
                <Badge variant={profileData?.twoFactorEnabled ? "default" : "outline"} className={profileData?.twoFactorEnabled ? "bg-gradient-to-r from-green-600 to-green-700 border-green-500" : ""}>
            ...
            <div className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-800/40 to-gray-900/40 rounded-xl border border-gray-600/30 hover:border-green-400/50 transition-all duration-300">
              ...
              <Badge variant={isEmailVerified ? "default" : "outline"} className={isEmailVerified ? "bg-gradient-to-r from-green-600 to-green-700 border-green-500" : ""}>
